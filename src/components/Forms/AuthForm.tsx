    ...
    <Card>
      <div className="text-center mb-8">
        <h1 className="text-2xl font-bold text-gray-800 mb-2">
          {mode === 'signup' ? MESSAGES.auth.signUpTitle : MESSAGES.auth.signInTitle}
        </h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          >
            {mode === 'signup' ? MESSAGES.auth.signUpButton : MESSAGES.auth.signInButton}
          </Button>
          ...
          >
            {mode === 'signup'
              ? MESSAGES.auth.toggleToSignIn
              : MESSAGES.auth.toggleToSignUp}
          </Button>
        </div>
      </form>
    </Card>
